...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mdf_toolbox-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mdf_toolbox-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mdf_toolbox
# for installing globally
pixi global install mdf_toolbox
```
...
It is possible to list all of the versions of `mdf_toolbox` available on your platform:
...
```
pixi search mdf_toolbox --channel conda-forge
```
